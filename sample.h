...
// SAMPLE_ORIGINAL
//
// Original implementation of a sample
//
...
const float dxxinv=1.0/(dx*dx);
const float dyyinv=1.0/(dy*dy);
const float dzzinv=1.0/(dz*dz);
const float dxyinv=1.0/(dx*dy);
const float dxzinv=1.0/(dx*dz);
const float dyzinv=1.0/(dy*dz);
